...
module MatchState = 
    ...
    let summaryStatus teamA teamB state =
        ...
        | A'Ongoing a1 -> sprintf "%s are %i for %i in their first innings" nameA a1.GetRuns a1.GetWickets
        | A'Completed a1 when a1.IsDeclared -> sprintf "%s scored %i for %i declared in their first innings" nameA a1.GetRuns a1.GetWickets
        | A'Completed a1 -> sprintf "%s scored %i all out in their first innings" nameA a1.GetRuns
        | AB'Ongoing (_, b1) & ALeads -> sprintf "%s trail by %s with %s remaining in their first innings" nameB (formatRuns leadA) (formatWicketsLeft b1.GetWickets)
        | AB'Ongoing (_, b1) & ScoresLevel -> sprintf "%s are level with %s remaining in their first innings" nameB (formatWicketsLeft b1.GetWickets)
        | AB'Ongoing (_, b1) & BLeads -> sprintf "%s lead by %s with %s remaining in their first innings" nameB (formatRuns leadB) (formatWicketsLeft b1.GetWickets)
        | AB'CompletedNoFollowOn _ & ALeads -> sprintf "%s lead by %s after the first innings" nameA (formatRuns leadA)
        | AB'CompletedNoFollowOn _ & ScoresLevel -> sprintf "%s are level after the first innings" nameB
        | AB'CompletedNoFollowOn _ & BLeads -> sprintf "%s lead by %s after the first innings" nameB (formatRuns leadB)
        | AB'CompletedPossibleFollowOn _ & ALeads -> sprintf "%s lead by %s after the first innings" nameA (formatRuns leadA)
        | AB'CompletedPossibleFollowOn _ & ScoresLevel -> sprintf "%s are level after the first innings" nameB
        | AB'CompletedPossibleFollowOn _ & BLeads -> sprintf "%s lead by %s after the first innings" nameB (formatRuns leadB)
        | ABA'Ongoing (_, _, a2) & BLeads -> sprintf "%s trail by %s with %s remaining in their second innings" nameA (formatRuns leadB) (formatWicketsLeft a2.GetWickets)
        | ABA'Ongoing (_, _, a2) & ScoresLevel -> sprintf "%s are level with %s remaining in their second innings" nameA (formatWicketsLeft a2.GetWickets)
        | ABA'Ongoing (_, _, a2) & ALeads -> sprintf "%s lead by %s with %s remaining in their second innings" nameA (formatRuns leadA) (formatWicketsLeft a2.GetWickets)
        | ABA'VictoryB _ -> sprintf "%s won by an innings and %s" nameB (formatRuns leadB)
        | ABA'Completed _ -> sprintf "%s need %s to win in their second innings" nameB (leadA + 1 |> formatRuns)
        | ABB'Ongoing (_, _, b2) & ALeads -> sprintf "%s trail by %s with %s remaining in their second innings" nameB (formatRuns leadA) (formatWicketsLeft b2.GetWickets)
        | ABB'Ongoing (_, _, b2) & ScoresLevel -> sprintf "%s are level with %s remaining in their second innings" nameB (formatWicketsLeft b2.GetWickets)
        | ABB'Ongoing (_, _, b2) & BLeads -> sprintf "%s lead by %s with %s remaining in their second innings" nameB (formatRuns leadB) (formatWicketsLeft b2.GetWickets)
        | ABB'VictoryA _ -> sprintf "%s won by an innings and %s" nameA (formatRuns leadA)
        | ABB'Completed _ -> sprintf "%s need %s to win in their second innings" nameA (leadB + 1 |> formatRuns)
        | ABAB'Ongoing (_, _, _, b2) -> sprintf "%s need %s to win with %s remaining" nameB (leadA + 1 |> formatRuns) (formatWicketsLeft b2.GetWickets)
        | ABAB'VictoryA _ -> sprintf "%s won by %s" nameA (leadA |> formatRuns)
        | ABAB'VictoryB (_, _, _, b2) -> sprintf "%s won by %s" nameB (formatWicketsLeft b2.GetWickets)
        | ABBA'Ongoing (_, _, _, a2) -> sprintf "%s need %s to win with %s remaining" nameA (leadB + 1 |> formatRuns) (formatWicketsLeft a2.GetWickets)
        | ABBA'VictoryB _ -> sprintf "%s won by %s" nameB (leadB |> formatRuns)
        | ABBA'VictoryA (_, _, _, a2) -> sprintf "%s won by %s" nameA (formatWicketsLeft a2.GetWickets)
