...
//        | _ -> Completed
    ...
    let DrawMatch rules state =
        ...
        | AB_Ongoing (a1, b1) | AB_CompletedNoFollowOn (a1, b1) | AB_CompletedPossibleFollowOn (a1, b1) -> AB_MatchDrawn (a1, b1)
    ...
    let UpdateInnings rules inningsUpdater state =
        ...
        | AB_Ongoing (a1, b1) ->
            ...
            | InningsCompleted i when (a1.GetRuns >= i.GetRuns + rules.FollowOnMargin) -> AB_CompletedPossibleFollowOn (a1, i)
        ...
        | ABAB_Ongoing (a1, b1, a2, b2) ->
            ...
            | InningsCompleted i when (a1.GetRuns + a2.GetRuns = b1.GetRuns + i.GetRuns) -> ABAB_MatchTied (a1, b1, a2, i)
